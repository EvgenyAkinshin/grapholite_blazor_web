...
export function canvas_setContext(canvasId) {
...
export function canvas_arcTo(x1, y1, x2, y2, radius) {
  arcTo(x1, y1, x2, y2, radius)
}

export function canvas_bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y) {
  ctx.bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y);
}

export function canvas_quadraticCurveTo(cpx, cpy, x, y) {
...
export function canvas_setAlpha(alpha) {
  ctx.globalAlpha = alpha;
}

export function canvas_setTransform(a, b, c, d, e, f) {
  ctx.setTransform(a, b, c, d, e, f);
}

export function canvas_setDashPattern() {
}
